...
| 2026-07-10 | Couple | **⚡ Real-audio looping playlist** — turn submitted/approved songs into a looping playlist with real audio on the site. Wanted *sooner rather than later*. Needs a solution design: embedded players (Spotify/YouTube embeds are the licensed route) vs hosted audio (licensing risk) vs 30s preview APIs | The Dancefloor becomes audible; prototype's "Currently playing" widget for real | new |
