 ...
 * then shows the three most recent; clicking one marks it read (if unread)
 * and opens the full message -- the list itself only ever shows an
 * 80-character snippet.
